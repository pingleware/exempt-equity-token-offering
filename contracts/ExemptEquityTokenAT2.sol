...
contract ExemptEquityTokenAT2 is ERC884, ERC20Mintable {
    string public constant name = "Regulation A Tier 2 Token";
    string public constant symbol = "TOKEN.AT2";
    ...
    uint256 constant public totalValueMax = 50000000;
