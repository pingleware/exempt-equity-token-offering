...
contract ExemptEquityTokenAT1 is ERC884, ERC20Mintable {
    string public constant name = "Regulation A Tier 1 Token";
    string public constant symbol = "TOKEN.AT1";
    ...
    uint256 constant public totalValueMax = 20000000;
